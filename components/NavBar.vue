  ...
  <div class="max-w-[1240px] bg-white mx-auto">
    <nav class="border-b border-black border-opacity-5">
      ...
      >
        ...
        <button class="font-bold hidden md:block border hover:bg-black hover:text-white duration-300 hover:border-black md:border-2 leading-121 py-2.5 text-xs md:text-base px-5 md:px-6 rounded-[40px]">Anmelden </button>
        <div class="flex items-center md:hidden gap-4">
          <button class="font-bold block md:hidden border hover:bg-black hover:text-white duration-300 hover:border-black md:border-2 leading-121 py-2.5 text-xs md:text-base px-5 md:px-6 rounded-[40px]">Anmelden </button>
